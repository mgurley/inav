...
describe PatientProviderAssignmentsController do
  ...
  describe "responding to GET index" do
    ...
    # it "should expose all patient_provider_assignments as @patient_provider_assignments" do
    #   PatientProviderAssignment.should_receive(:find).with(:all).and_return([mock_patient_provider_assignment])
    #   get :index
    #   assigns[:patient_provider_assignments].should == [mock_patient_provider_assignment]
    # end
    # 
    # describe "with mime type of xml" do
    #   
    #   it "should render all patient_provider_assignments as xml" do
    #     request.env["HTTP_ACCEPT"] = "application/xml"
    #     PatientProviderAssignment.should_receive(:find).with(:all).and_return(patient_provider_assignments = mock("Array of PatientProviderAssignments"))
    #     patient_provider_assignments.should_receive(:to_xml).and_return("generated XML")
    #     get :index
  ...
  describe "responding to GET show" do
    ...
    # describe "with mime type of xml" do
    # 
    #   it "should render the requested patient_provider_assignment as xml" do
    #     request.env["HTTP_ACCEPT"] = "application/xml"
    #     PatientProviderAssignment.should_receive(:find).with("37").and_return(mock_patient_provider_assignment)
    #     mock_patient_provider_assignment.should_receive(:to_xml).and_return("generated XML")
    #     get :show, :id => "37"
    #     response.body.should == "generated XML"
    #   end
    # 
  ...
  describe "responding to POST create" do
    ...
    describe "with valid params" do
      ...
      it "should redirect to the created patient_provider_assignment" do
        Patient.should_receive(:find).with("37").and_return(mock_patient)
  ...
  describe "responding to PUT udpate" do
    ...
    describe "with valid params" do
      ...
      it "should redirect to the patient_provider_assignment" do
        Patient.should_receive(:find).with("37").and_return(mock_patient)
        PatientProviderAssignment.stub!(:find).and_return(mock_patient_provider_assignment(:update_attributes => true))
        put :update, :id => "1", :patient_id => "37"
        response.should redirect_to(patient_url(mock_patient))
