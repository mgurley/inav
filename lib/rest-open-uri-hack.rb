...
module Kernel
  private
  alias open_uri_original_open_hack open # :nodoc:
  ...
  def open(name, *rest, &block) # :doc:
    if name.respond_to?(:open)
      ...
      open_uri_original_open_hack(name, *rest, &block)
    end
  end
...
module OpenURI
  ...
  def OpenURI.open_http(buf, target, proxy, options) # :nodoc:
    ...
    when Net::HTTPSuccess,
         #11/15/2008  MGURLEY This is the hack.  We are interpreting 303 as success because that is what the Patient Study Calendar
         #                    returns upon a successful Post/Put.  It should return a HTTPSuccess.
