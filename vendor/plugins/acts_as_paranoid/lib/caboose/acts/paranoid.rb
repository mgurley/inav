    ...
    module Paranoid
      ...
      module InstanceMethods #:nodoc:
        ...
        def destroy_without_callbacks
          unless new_record?
#            self.class.update_all self.class.send(:sanitize_sql, ["#{self.class.deleted_attribute} = ?", (self.deleted_at = self.class.send(:current_time)),"self.update_by",current_session_user]), ["#{self.class.primary_key} = ?", id]
